...
public class PictureAdapter extends PagerAdapter {
    ...
    public View instantiateItem(ViewGroup container, int position) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.picture_adpter_item, null);
        View picture =  view.findViewById(R.id.picture_sdv);
    ...
    public void setCurrentItem(String id,OnePictureData data){
        ...
        for (int i=0;i<viewBeans.size();i++) {
            if (viewBeans.get(i).id.equals(id)) {
                ...
                viewBeans.get(i).state=PictureViewBean.NORMAL;                Log.e("test1","notifyDataSetChanged");
