...
//
//import cn.diwinet.watersteward.activity.BrandSelectActivity;
//
///**
...
//    public void initPositions(List<T> brands) {
//
//        int sectionCount = mSections.length;
...
//        for (T brand : brands) {
//
//            String indexableItem = ((BrandSelectActivity.BrandData) brand).pinyin;
