...
public class JsonUtil {
    ...
    public static String toJson(Object target, Type targetType, boolean isSerializeNulls, Double version,
        ...
        if (StringUtil.isBlank(datePattern)) datePattern = DEFAULT_DATE_PATTERN;
    ...
    public static <T> T fromJson(String json, TypeToken<T> token, String datePattern, boolean excludesFieldsWithoutExpose) {
